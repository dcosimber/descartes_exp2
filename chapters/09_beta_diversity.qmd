...
![Bray ASV hydro global](../assets/results/07_beta_diversity/figures/bray/hydro_global/beta_bray_asv_hydro_global.svg)
...
![Aitchison genus hydro global](../assets/results/07_beta_diversity/figures/aitchison/hydro_global/beta_aitchison_genus_hydro_global.svg)
...
![Bray ASV diet by time](../assets/results/07_beta_diversity/figures/bray/diet_by_time/beta_bray_asv_diet_by_time.svg)

**Figura 3. Ordenaciones Bray-Curtis locales comparando `Ctrl`, `BL15` y `BL30` dentro de cada tiempo a nivel de ASV.**

![Aitchison genus diet by time](../assets/results/07_beta_diversity/figures/aitchison/diet_by_time/beta_aitchison_genus_diet_by_time.svg)
...
![Bray ASV hydro by time](../assets/results/07_beta_diversity/figures/bray/hydro_by_time/beta_bray_asv_hydro_by_time.svg)

**Figura 5. Ordenaciones Bray-Curtis locales comparando `Ctrl` frente a `Hydrolysate` dentro de cada tiempo a nivel de ASV.**

![Aitchison genus hydro by time](../assets/results/07_beta_diversity/figures/aitchison/hydro_by_time/beta_aitchison_genus_hydro_by_time.svg)
...
![Bray ASV time by diet](../assets/results/07_beta_diversity/figures/bray/time_by_diet/beta_bray_asv_time_by_diet.svg)

**Figura 7. Ordenaciones Bray-Curtis locales comparando `D07`, `D30` y `D90` dentro de cada dieta a nivel de ASV.**

![Aitchison genus time by diet](../assets/results/07_beta_diversity/figures/aitchison/time_by_diet/beta_aitchison_genus_time_by_diet.svg)
...
![Bray ASV ctrl hydro feed](../assets/results/07_beta_diversity/figures/bray/ctrl_hydro_feed/beta_bray_asv_ctrl_hydro_feed.svg)
...
![Aitchison genus ctrl hydro feed](../assets/results/07_beta_diversity/figures/aitchison/ctrl_hydro_feed/beta_aitchison_genus_ctrl_hydro_feed.svg)
