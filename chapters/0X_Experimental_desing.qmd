# Experimento 2: diseño experimental, animales de experimentación y dietas
...
El ensayo se diseñó como continuación del Experimento 1, en el que la inclusión de hidrolizado proteico de lirio de bajo peso molecular mostró resultados compatibles con su uso como ingrediente sostenible en dietas para rodaballo. En este segundo experimento se decidió mantener el mismo hidrolizado, pero aumentar los niveles de inclusión para evaluar porcentajes más altos de sustitución de harina de pescado. :contentReference[oaicite:0]{index="0"}

El objetivo principal fue evaluar si dietas formuladas con hidrolizado proteico de lirio (*Micromesistius poutassou*) de bajo peso molecular, 1–2 kDa, podían sustituir parcial o totalmente la harina de pescado sin comprometer la respuesta fisiológica, histológica y microbiológica del rodaballo.

## 2. Objetivo experimental

El objetivo específico del Experimento 2 fue comparar tres formulaciones dietéticas:

-   una dieta control con harina de pescado y sin hidrolizado;
-   una dieta con inclusión intermedia de hidrolizado de lirio;
-   una dieta con inclusión alta de hidrolizado, planteada como sustitución completa de la harina de pescado.

A nivel de microbiota, el objetivo fue determinar si las dietas experimentales producían una comunidad intestinal comparable a la observada en peces alimentados con el pienso control, utilizando la microbiota intestinal como bioindicador de salud, bienestar y adaptación digestiva. :contentReference[oaicite:1]{index="1"}
...
## 6. Composición general de las dietas
...
## 7. Composición completa de los piensos
...
## 8. Composición proximal de los piensos
...
## 10. Condiciones de mantenimiento
