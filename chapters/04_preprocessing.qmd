...
El resultado práctico de `cutadapt` fue muy bueno: en `run_02_optimized` se retuvieron **9,191,390 pares**, es decir, una **mediana de retención del 100%**. Esta retención no significa que todas las lecturas pasen el control final, sino que no se perdieron en la etapa técnica de recorte de primers.
